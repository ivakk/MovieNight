...
namespace MovieNight_Tests
{
    ...
    public class MovieManagerTests
    {
        ...
        {
            // Arrange
            fakeMovieRepository.CreateMovie(new Movie { Title = "Test Movie 1" });
            fakeMovieRepository.CreateMovie(new Movie { Title = "Test Movie 2" });
        ...
        {
            // Arrange
            var movie = new Movie { Title = "Unique Movie" };
        ...
        {
            // Arrange
            var movie = new Movie { Title = "To Be Deleted" };
            fakeMovieRepository.CreateMovie(movie);
        ...
        // Additional tests can be added for Get7, GetBySearch, etc.
    }
}

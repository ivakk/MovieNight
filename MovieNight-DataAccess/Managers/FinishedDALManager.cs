...
{
    public class FinishedDALManager : Connection, IFinishedDALManager
    {
        private readonly string tableName = "Finished";
        public FinishedDALManager()
        {
        }
        ...
        */
        ...
        {
            string query = $"DELETE FROM {tableName} WHERE mediaId = @mediaId AND userId = @userId ORDER BY time DESC";
